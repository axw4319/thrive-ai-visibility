...
// Tried moving brand extraction to Gemini 2.5 Flash thinkingBudget=0 in
// a56369e — same Gemini key already powering the gemini + google_ai_mode
// engines is now hit 9× per scan (3 engines × 3 prompts + 3 extracts),
// pushing one Gemini engine call to 32s on SCAN 69 because of rate-limit
// contention. Stick with gpt-4o-mini for extraction — different provider
// = different rate-limit bucket from Gemini engines.
