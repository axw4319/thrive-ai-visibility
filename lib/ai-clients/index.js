...
const googleAiModeClient = require('./google-ai-mode');
...
const ALL_CLIENTS = {
  ...
  google_ai_mode: googleAiModeClient,
};

const enabledNames = (process.env.AI_MODELS || 'chatgpt,gemini,perplexity,google_ai_mode')
