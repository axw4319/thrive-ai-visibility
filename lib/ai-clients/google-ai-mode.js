...
async function query(promptText) {
  // gemini-1.5-flash with the AI Mode system prompt — same fast model the
  // plain `gemini` engine uses, differentiated by the system prompt so the
  // two engines surface different brand mixes for the same query.
