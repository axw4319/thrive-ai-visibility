...
async function query(promptText) {
  // gemini-2.0-flash: same fast model the plain `gemini` engine uses; we
  // differentiate response style via the AI Mode system prompt above so the
  // two engines surface different brand mixes for the same prompt.
